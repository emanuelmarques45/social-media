...
namespace SocialMedia.Api.Migrations
{
    ...
    [Migration("20250217231429_ApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialMedia.Classes.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ApplicationUserApplicationUser", b =>
                {
                    b.HasOne("SocialMedia.Classes.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocialMedia.Classes.Models.ChildCommentModel", b =>
                {
                    ...
                    b.HasOne("SocialMedia.Classes.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
