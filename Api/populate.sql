...
INSERT INTO [dbo].[Users] ([Name], [Email], [Username], [Password], [CreatedAt])
VALUES
    ('John Doe', 'john.doe@example.com', 'john.doe', 'password123', GETDATE()),
    ('Jane Smith', 'jane.smith@example.com', 'jane.smith', 'password456', GETDATE()),
    ('Alice Johnson', 'alice.johnson@example.com', 'alice.johnson', 'password789', GETDATE()),
    ('Bob Brown', 'bob.brown@example.com', 'bob.brown', 'password012', GETDATE()),
    ('Carol White', 'carol.white@example.com', 'carol.white', 'password345', GETDATE()),
    ('David Green', 'david.green@example.com', 'david.green', 'password678', GETDATE()),
    ('Eve Black', 'eve.black@example.com', 'eve.black', 'password901', GETDATE()),
    ('Frank Blue', 'frank.blue@example.com', 'frank.blue', 'password234', GETDATE()),
    ('Grace Gray', 'grace.gray@example.com', 'grace.gray', 'password567', GETDATE()),
    ('Hannah Red', 'hannah.red@example.com', 'hannah.red', 'password890', GETDATE()),
    ('Ivy King', 'ivy.king@example.com', 'ivy.king', 'password1234', GETDATE()),
    ('James Lee', 'james.lee@example.com', 'james.lee', 'password5678', GETDATE()),
    ('Laura Turner', 'laura.turner@example.com', 'laura.turner', 'password91011', GETDATE()),
    ('Mark Adams', 'mark.adams@example.com', 'mark.adams', 'password1213', GETDATE()),
    ('Nina Scott', 'nina.scott@example.com', 'nina.scott', 'password1415', GETDATE()),
    ('Oscar Harris', 'oscar.harris@example.com', 'oscar.harris', 'password1617', GETDATE()),
    ('Paula Miller', 'paula.miller@example.com', 'paula.miller', 'password1819', GETDATE()),
    ('Quincy Moore', 'quincy.moore@example.com', 'quincy.moore', 'password2021', GETDATE()),
    ('Rita Nelson', 'rita.nelson@example.com', 'rita.nelson', 'password2223', GETDATE()),
    ('Sam Patel', 'sam.patel@example.com', 'sam.patel', 'password2425', GETDATE()),
    ('Tina Rogers', 'tina.rogers@example.com', 'tina.rogers', 'password2627', GETDATE()),
    ('Ulysses Green', 'ulysses.green@example.com', 'ulysses.green', 'password2829', GETDATE()),
    ('Vera Adams', 'vera.adams@example.com', 'vera.adams', 'password3031', GETDATE()),
    ('Will Carter', 'will.carter@example.com', 'will.carter', 'password3233', GETDATE()),
    ('Xander Lopez', 'xander.lopez@example.com', 'xander.lopez', 'password3435', GETDATE()),
    ('Yara Brooks', 'yara.brooks@example.com', 'yara.brooks', 'password3637', GETDATE()),
    ('Zane Cooper', 'zane.cooper@example.com', 'zane.cooper', 'password3839', GETDATE()),
    ('Alice White', 'alice.white@example.com', 'alice.white', 'password4041', GETDATE()),
    ('Bob Smith', 'bob.smith@example.com', 'bob.smith', 'password4243', GETDATE()),
    ('Clara Johnson', 'clara.johnson@example.com', 'clara.johnson', 'password4445', GETDATE()),
    ('Derek Adams', 'derek.adams@example.com', 'derek.adams', 'password4647', GETDATE()),
    ('Ella Davis', 'ella.davis@example.com', 'ella.davis', 'password4849', GETDATE()),
    ('Felix Martin', 'felix.martin@example.com', 'felix.martin', 'password5051', GETDATE()),
    ('Gina Lewis', 'gina.lewis@example.com', 'gina.lewis', 'password5253', GETDATE()),
    ('Henry Clark', 'henry.clark@example.com', 'henry.clark', 'password5455', GETDATE()),
    ('Iris Young', 'iris.young@example.com', 'iris.young', 'password5657', GETDATE()),
    ('Jake Walker', 'jake.walker@example.com', 'jake.walker', 'password5859', GETDATE()),
    ('Kimberly Scott', 'kimberly.scott@example.com', 'kimberly.scott', 'password6061', GETDATE()),
    ('Liam Roberts', 'liam.roberts@example.com', 'liam.roberts', 'password6263', GETDATE()),
    ('Maya Carter', 'maya.carter@example.com', 'maya.carter', 'password6465', GETDATE()),
    ('Nolan Green', 'nolan.green@example.com', 'nolan.green', 'password6667', GETDATE()),
    ('Olivia Lewis', 'olivia.lewis@example.com', 'olivia.lewis', 'password6869', GETDATE()),
    ('Paul Walker', 'paul.walker@example.com', 'paul.walker', 'password7071', GETDATE()),
    ('Quinn Scott', 'quinn.scott@example.com', 'quinn.scott', 'password7273', GETDATE()),
    ('Riley Young', 'riley.young@example.com', 'riley.young', 'password7475', GETDATE()),
    ('Sophia Martin', 'sophia.martin@example.com', 'sophia.martin', 'password7677', GETDATE()),
    ('Tyler Jones', 'tyler.jones@example.com', 'tyler.jones', 'password7879', GETDATE()),
    ('Ursula Clark', 'ursula.clark@example.com', 'ursula.clark', 'password8081', GETDATE()),
    ('Victor Roberts', 'victor.roberts@example.com', 'victor.roberts', 'password8283', GETDATE()),
    ('Wendy Adams', 'wendy.adams@example.com', 'wendy.adams', 'password8485', GETDATE()),
    ('Xena Lewis', 'xena.lewis@example.com', 'xena.lewis', 'password8687', GETDATE()),
    ('Yvonne Miller', 'yvonne.miller@example.com', 'yvonne.miller', 'password8889', GETDATE()),
    ('Zachary Davis', 'zachary.davis@example.com', 'zachary.davis', 'password9091', GETDATE()),
    ('Ava Harris', 'ava.harris@example.com', 'ava.harris', 'password9293', GETDATE()),
    ('Brian Taylor', 'brian.taylor@example.com', 'brian.taylor', 'password9495', GETDATE()),
    ('Catherine Moore', 'catherine.moore@example.com', 'catherine.moore', 'password9697', GETDATE()),
    ('Diana Wilson', 'diana.wilson@example.com', 'diana.wilson', 'password9899', GETDATE()),
    ('Eric Thompson', 'eric.thompson@example.com', 'eric.thompson', 'password100101', GETDATE()),
    ('Fiona White', 'fiona.white@example.com', 'fiona.white', 'password102103', GETDATE()),
    ('George Hall', 'george.hall@example.com', 'george.hall', 'password104105', GETDATE()),
    ('Hannah Taylor', 'hannah.taylor@example.com', 'hannah.taylor', 'password106107', GETDATE()),
    ('Ian Scott', 'ian.scott@example.com', 'ian.scott', 'password108109', GETDATE()),
    ('Julia King', 'julia.king@example.com', 'julia.king', 'password110111', GETDATE());
GO
